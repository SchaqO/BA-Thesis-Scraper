...
class CnnspiderSpider(scrapy.Spider):
    ...
    def __init__(self):
        ...
        # begin search
        search_input = driver.find_element(By.XPATH, "/html/body/div[1]/div[2]/footer/div/div[1]/form/input") # find the search bar
        search_input.send_keys("tech") # type in the search term
        search_btn = driver.find_element(By.XPATH, "/html/body/div[1]/div[2]/footer/div/div[1]/form/button") # find the search button
        search_btn.click()
        ...
        while i < 100: # 100 is just right to get us back to July
            ...
            next_btn = driver.find_element(By.XPATH, "(//div[contains(@class, 'pagination-arrow')])[2]") # click next button
            next_btn.click()
